...
time_var = '20240808-103639'
run_suffix = "Z_end"
run_num = 4000
project_name = "PINN-elastodynamics-SteelSHM_train"
run_id = "w75fee74"
...
if __name__ == "__main__":
    ...
    x_dist, y_dist, t_dist = GenDistPt(xmin=0, xmax=w/L_star, ymin=0, ymax=h/L_star, tmin=0, tmax=tmax/T_star,
                                       num=21, num_t=21)
    ...
    with tf.device('/device:GPU:%s'%(DEVICE)):      
        ...
        model = PINN(XYT_c, P1, P2, P3, IC, LF, RT, UP, LW, DIST, 
                     ...
                     uvDir='/zAdam2_uvNN_float64.pickle'#'/uvNN_float64.pickle_'+run_suffix 
                    , run_num = run_num)
